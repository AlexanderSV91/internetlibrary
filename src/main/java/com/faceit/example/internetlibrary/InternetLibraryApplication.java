...
У каждого действия с книгой есть дата действия , статус, читатель, книга ,
состояние книги. Нужно сделать простой функционал: после авторизации
(регистрацию пользователя можно не делать, просто руками добавить несколько пользователей в БД)
у пользователя есть возможность просмотреть список взятых книг, взять новую, отредактировать или удалить существующие.
Запросы по созданию/редактированию/удалению
нужно сделать через Ajax. Все веб сервисы(создание задачи/редактирование/удаление) должны работать через JSON.
Для верстки можно использовать Boostrap CSS.
